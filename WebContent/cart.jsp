...
<div class="body-content outer-top-xs">
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			...
			html += "</tr>";	
			HashMap<Integer, Movie> cart = (HashMap<Integer, Movie>)session.getAttribute("cart");
			for (Movie m : cart.values()) {
				String htmlRow = html;
				htmlRow = htmlRow.replaceFirst("__TITLE__", m.getTitle());
				htmlRow = htmlRow.replaceFirst("__DELURL__", "cart?mid=" + m.getId() + "&action=del");
			...
			<tr>
				<th>
					<div class="cart-grand-total">
						Grand Total<span class="inner-left-md">$<% out.print(String.format("%.2f", total)); %></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
